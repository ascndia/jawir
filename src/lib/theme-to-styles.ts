import { hslToVariableValue } from "@/lib/hsl-to-variable-value";
import { backfillCharts } from "@/lib/create-theme-config";
import { chartKeys, type Hsl, type Theme } from "@/lib/theme-config";

import { invert, keys } from "remeda";
...
export const cssToTheme = (styles: string) => {
  ...
  return {
    light: Object.fromEntries(lightThemeEntries),
    dark: Object.fromEntries(darkThemeEntries),
    errors,
  };
};
